    ...
    <div className={`${completed ? "mb-14" : ""}`}>
        ...
        { showBlock && !completed ? 
            ...
            {value.map((item, index) => (
                <>
                <div key={index} onClick={(e) => handleEditToDo(e, item)} className={`flex cursor-pointer w-66.5 h-30 items-center justify-between px-2 border border-[#D8E0D9] ${menu ? "" : editList ? "grow max-w-89" : "grow max-w-70.5"}`}>
